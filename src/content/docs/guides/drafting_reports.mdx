...
[Performing Analyses](/guides/performing_analyses)) to ensure full functionality
of `reportifyr`.

## Populating a Report

In [Performing Analyses](/guides/performing_analyses), 
