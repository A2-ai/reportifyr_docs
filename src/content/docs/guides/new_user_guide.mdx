...
![](/images/pk-params.png)

![](/images/theoph-pk-exposure.png)
...
- **each caption is accompanied by a magic string**
...
[Initializing Reportifyr](/guides/initializing_reportifyr), 
[Performing Analyses](/guides/performing_analyses),
and [Drafting Reports](/guides/drafting_reports).
