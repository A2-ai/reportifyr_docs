...
- **Get Meta Abbreviations Reference**: Refer to the reference on `get_meta_abbrevs()` [here](/reportifyr_docs/reference/metadata/get_meta_abbrevs).
- **Get Meta Type Reference**: Refer to the reference on `get_meta_type()` [here](/reportifyr_docs/reference/metadata/get_meta_type).
