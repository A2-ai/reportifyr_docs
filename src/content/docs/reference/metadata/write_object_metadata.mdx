...
- **Get Meta Abbreviations Reference**: Refer to the reference on `get_meta_abbrevs()` [here](/reference/metadata/get_meta_abbrevs).
- **Get Meta Type Reference**: Refer to the reference on `get_meta_type()` [here](/reference/metadata/get_meta_type).
