...
- **Add Footnotes Reference**: Refer to the reference on `add_footnotes()` [here](/reference/document_interacting/add_footnotes).
- **Add Plots Reference**: Refer to the reference on `add_plots()` [here](/reference/document_interacting/add_plots).
- **Add Tables Reference**: Refer to the reference on `add_tables()` [here](/reference/document_interacting/add_tables).
- **Make Doc Dirs Reference**: Refer to the reference on `make_doc_dirs()` [here](/reference/utilities/make_doc_dirs).
- **Remove Tables, Figures, and Footnotes Reference**: Refer to the reference on `remove_tables_figures_footnotes()` [here](/reference/document_interacting/remove_tables_figures_footnotes).
